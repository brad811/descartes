...
var renderGraphs = function() {
  ...
  return $.ajax({
    ...
    for (var i in d.graphs) {
      ...
      $('div.graphs div.row span#' + d.graphs[i].uuid).append('<a href="/graphs/' + d.graphs[i].uuid + (($.url().param('interval')!=null)?'?interval=' + $.url().param('interval'):'') + '"><img src="' + constructGraphUrl(c) + '" alt="' + d.graphs[i].name + '" name="' + d.graphs[i].uuid + '" /></a>');
